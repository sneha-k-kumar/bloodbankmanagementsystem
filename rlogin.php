...
<html>
	...
	<head>
		...
		<title>Login | Receiver login form</title>
	...
	<body>
	   <?php require 'message.php'; ?>
			...
			<div class="container">
				...
				<div class="box-wrapper">				
					<div class="box box-border">
						<div class="box-body">
						<center> <h5 style="font-family: Noto Sans;">Login to </h5><h4 style="font-family: Noto Sans;">Receiver</h4></center>
							...
							<div class="form-group text-center">
								<span class="text-muted">Don't have an account?</span> <a href="rregister.php">Register</a> Here..
							</div>
							<div class="form-group text-center">
							    <span class="text-muted"></span> <a href="index.php">HOME</a><br><br>
							</div>
						</div>
					</div>
				</div>
		...
		<script src="scripts/bootstrap/bootstrap.min.js"></script><br><br><br>
