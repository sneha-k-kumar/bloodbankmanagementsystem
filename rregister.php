...
<html>
    <head>
		...
		<title>Register | Receiver registration form</title>
			...
			<?php require 'message.php'; ?>
				<div class="box-wrapper">				
					<div class="box box-border">
						<div class="box-body">
						<center> <h5 style="font-family: Noto Sans;">Register to </h5><h4 style="font-family: Noto Sans;">Blood Bank Management System</h4></center>
								<form action="file/receiverReg.php" method="post" enctype="multipart/form-data">
									...
									<span class="text-muted">have an account?</span> <a href="rlogin.php">login</a> Here..
								    </div>
								    <div class="form-group text-center">
