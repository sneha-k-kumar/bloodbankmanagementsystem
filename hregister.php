			...
			<div class="container">
				<div class="box-wrapper">				
					<div class="box box-border">
						<div class="box-body">
						<center> <h5 style="font-family: Noto Sans;">Register to </h5><h4 style="font-family: Noto Sans;">Hospital</h4></center>
						...
						<center><span class="text-muted">have an account?</span> <a href="hlogin.php">login</a> Here..</center></div>
